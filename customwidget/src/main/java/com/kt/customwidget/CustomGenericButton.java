...
public class CustomGenericButton extends LinearLayout {

    public static final String TAG = CustomGenericButton.class.getSimpleName();
     ...
     */
    public CustomGenericButton(Context context) {
        super(context);
     ...
     */
    public CustomGenericButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    ...
    private TextView setupTextView() {
        ...
        if (mTextDesc == null) {
            mTextDesc = "Fancy Desc";
        }

        String textToSet = "";
        String mTextBold = "<b>" + mText + "</b>";
        if (mTextDesc.equals("")) {
            textToSet = String.valueOf(Html.fromHtml(mTextBold));
        } else {
            textToSet = Html.fromHtml(mTextBold) + "\n" + mTextDesc;
        }
    ...
    private void initAttributesArray(TypedArray attrsArray) {
        ...
        String textDesc = attrsArray.getString(R.styleable.FancyButtonsAttrs_fb_text_desc);

        if (textDesc == null) {
            textDesc = attrsArray.getString(R.styleable.FancyButtonsAttrs_android_text);
        }
        ...
        if (textDesc != null)
            mTextDesc = mTextAllCaps ? text.toUpperCase() : textDesc;
